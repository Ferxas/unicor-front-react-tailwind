...
import { GiNotebook, GiHouseKeys } from "react-icons/gi";
import { FaLifeRing, FaPen } from "react-icons/fa";
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-shrink-0 items-center">
                <img
                  className="h-14 w-auto mr-20"
                  src="../public/modernlogo.png"
                  ...
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://static.wikia.nocookie.net/sel/images/7/7f/Serial_Experiments_Lain_English_Dub_Episode_5_6-29_screenshot.png/"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
